...
function sumArray(sumArr) {
  ...
  console.log(sumArr)
  let total = 0;
  for (let number_index in sumArr) {
    total = sum(total, sumArr[number_index])[0];
  }
...
// sumArray(); //uncomment it to run it
...
function multiplyAnyArray(dynamicArray) {
  let product = 1;
  for(let number_index in dynamicArray){
    product = multiply(product, dynamicArray[number_index])[0];
  }
  console.log(product);
